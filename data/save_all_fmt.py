...
codecs = ["R32G32B32A32_FLOAT", "R32G32B32A32_UINT", "R32G32B32A32_SINT",
...
for codec in codecs:
    Popen(f'texconv.exe -ft DDS -f {codec} fungus.png', SW_HIDE).wait()
    shutil.move('fungus.DDS', f'out\\{codec}.dds')
